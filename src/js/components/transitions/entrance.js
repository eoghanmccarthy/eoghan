    ...
    return [
        ...
        <StaggeredMotion
          ...
          styles={prevStyles => prevStyles.map((_, i) => {
            return i === 0
              ...
              : {
                  y: spring(prevStyles[i - 1].y, { stiffness: finalStiffness, damping: finalDamping }),
        ...
        >
          {interpolatingStyles =>
			...
			<ContentSidebar>
				<h3>React Motion</h3>
				<p>Staggered motion of a single component iterated by a map. Number of items is determined by the length of a 'library' array.</p><p><a href="https://github.com/chenglou/react-motion#staggeredmotion-" target="_blank">reference</a></p>
      </ContentSidebar>
    ]
  }
}
